...
function App({ Component, pageProps = { title: 'index' } }) {
  ...
  // useEffect(() => {
  //   setTest(useStore.getState().test)
  //   console.log("°° ", useStore.getState().test)
  //   console.log("-- ", test)
  ...
  return (
    <>
      ...
      <div className={ `background-test ${ !test && 'is-hide' } ${ 'is-'+useStore.getState().ink }` }/>
      {!isPreload && !isMobile && <Canvas />}
    </>
  )
}
