...
const datas = {
  title: "Hey, I'm Tom.",
  description: "A creative producer with experience building experiences, documentaries and visual narratives for the web. Currently leading production at Immersive Garden and Buried Signals.",
