...
const datas = {
  title: "Hey, I'm Tom.",
  description: "A creative producer building experiences, documentaries and visual narratives for the web. Currently running Buried Signals and Nuanced Studio while studying information design at Parsons.",
